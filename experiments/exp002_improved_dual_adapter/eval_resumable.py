"""
Resumable evaluation script for exp002 with checkpoint support.
...
def print_summary(results: Dict[str, Any]):
    ...
    print("\n" + "="*80)
    print("EVALUATION SUMMARY - EXP002")
    print("="*80)
...
def main():
    ...
    # Setup logging
    log_dir = project_root / "results" / "exp002_improved_dual_adapter" / "logs"
    ...
    logging.info("="*80)
    logging.info("RESUMABLE EVALUATION - EXP002")
    logging.info("="*80)
